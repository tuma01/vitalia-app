# Vitalia Medical Module

## Overview
The `vitalia-medical` module is where the healthcare business happens. This module was created during Phase 2 of the 2026 refactoring to isolate medical-specific entities and logic from administrative ones.
...
## Table Prefix
Tables in this module use the **`MED_`** prefix (Medical).
...
<dependency>
    ...
    <artifactId>vitalia-medical</artifactId>
</dependency>
```
