...
public interface TenantAdminApi extends GenericApi<TenantAdminDto> {
        ...
        ResponseEntity<TenantAdminDto> createTenantAdmin(
                        @Parameter(description = "Detalles del " + NAME_API
                                        + " a crear.", required = true) @Valid @RequestBody TenantAdminDto dto);
        ...
        ResponseEntity<TenantAdminDto> updateTenantAdmin(
                        ...
                        @Parameter(description = "Nuevos detalles del " + NAME_API
                                        + ".", required = true) @Valid @RequestBody TenantAdminDto dto);
        ...
        ResponseEntity<Void> resetAdminPassword(@PathVariable Long id,
