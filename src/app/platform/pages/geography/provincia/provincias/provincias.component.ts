...
export class ProvinciasComponent implements OnInit {
    ...
    createNew(): void {
        this.router.navigate(['/platform/geography/provincia/addProvincia']);
    }

    edit(record: Provincia): void {
        this.router.navigate(['/platform/geography/provincia/editProvincia'], {
