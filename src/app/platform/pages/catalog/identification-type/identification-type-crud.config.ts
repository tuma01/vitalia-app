...
export const IDENTIFICATION_TYPE_CRUD_CONFIG = (): CrudConfig<IdentificationType> => {
    ...
    return {
        ...
        columns: [
            ...
            { field: 'code', header: 'menu.catalog.identification_type.fields.code', sortable: true, width: '150px' },
            { field: 'name', header: 'menu.catalog.identification_type.fields.name', sortable: true, width: '300px' },
            {
                field: 'active',
