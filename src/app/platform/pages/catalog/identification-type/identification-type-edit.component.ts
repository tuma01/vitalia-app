...
import { IDENTIFICATION_TYPE_CRUD_CONFIG } from './identification-type-crud.config';
import { IdentificationType } from 'app/api/models/identification-type';

@Component({
    selector: 'app-identification-type-edit',
    standalone: true,
...
export class IdentificationTypeEditComponent extends CrudBaseAddEditComponent<IdentificationType> implements OnInit {
    protected override entityNameKey = 'catalog.identification_type.singular';
    public readonly config = IDENTIFICATION_TYPE_CRUD_CONFIG();
    ...
    protected override getSuccessRoute(): any[] {
        return ['/platform/catalog/identification-type/list'];
    }
