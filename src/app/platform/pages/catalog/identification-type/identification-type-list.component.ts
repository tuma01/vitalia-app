...
export class IdentificationTypeListComponent {
    ...
    config = IDENTIFICATION_TYPE_CRUD_CONFIG();
        ...
        this.config.columns.push(
            (getOperationColumn(
                this.translate,
                {
                    ...
                    entityType: 'catalog.identification_type.singular',
    ...
    createNew(): void {
        this.router.navigate(['/platform/catalog/identification-type/add']);
    }

    edit(record: IdentificationType): void {
        this.router.navigate(['/platform/catalog/identification-type/edit'], {
