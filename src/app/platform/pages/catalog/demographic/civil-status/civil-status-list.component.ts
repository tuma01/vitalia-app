...
import { CIVIL_STATUS_CRUD_CONFIG } from './civil-status-crud.config';
...
@Component({
    selector: 'app-civil-status-list',
    standalone: true,
...
export class CivilStatusListComponent {
    ...
    config = CIVIL_STATUS_CRUD_CONFIG();
    ...
    createNew(): void {
        this.router.navigate(['/platform/catalog/demographics/civil-status/add']);
    }

    edit(record: CivilStatus): void {
        this.router.navigate(['/platform/catalog/demographics/civil-status/edit'], {
