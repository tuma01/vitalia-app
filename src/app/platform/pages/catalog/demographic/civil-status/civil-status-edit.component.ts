...
@Component({
    selector: 'app-civil-status-edit',
    standalone: true,
...
export class CivilStatusEditComponent extends CrudBaseAddEditComponent<CivilStatus> implements OnInit {
    protected override entityNameKey = 'menu.catalog.demographics.civil_status.singular';
    public readonly config = CIVIL_STATUS_CRUD_CONFIG();
    ...
    protected override getSuccessRoute(): any[] {
        return ['/platform/catalog/demographics/civil-status/list'];
    }
