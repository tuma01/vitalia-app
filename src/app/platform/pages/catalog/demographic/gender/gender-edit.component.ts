...
export class GenderEditComponent extends CrudBaseAddEditComponent<Gender> implements OnInit {
    protected override entityNameKey = 'menu.catalog.demographics.gender.singular';
    public readonly config = GENDER_CRUD_CONFIG();
    ...
    protected override getSuccessRoute(): any[] {
        return ['/platform/catalog/demographics/gender/list'];
    }
