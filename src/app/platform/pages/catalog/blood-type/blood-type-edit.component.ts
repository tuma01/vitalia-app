...
import { BLOOD_TYPE_CRUD_CONFIG } from './blood-type-crud.config';
import { BloodType } from 'app/api/models/blood-type';

@Component({
    selector: 'app-blood-type-edit',
    standalone: true,
...
export class BloodTypeEditComponent extends CrudBaseAddEditComponent<BloodType> implements OnInit {
    protected override entityNameKey = 'clinical.blood_type.singular';
    public readonly config = BLOOD_TYPE_CRUD_CONFIG();
    ...
    protected override getSuccessRoute(): any[] {
        return ['/platform/catalog/blood-type/list'];
    }
