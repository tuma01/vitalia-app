...
export class BloodTypeListComponent {
        ...
        this.config.columns.push(
            (getOperationColumn(
                this.translate,
                {
                    ...
                    entityType: 'clinical.blood_type.singular',
    ...
    createNew(): void {
        this.router.navigate(['/platform/catalog/blood-type/add']);
    }

    edit(record: BloodType): void {
        this.router.navigate(['/platform/catalog/blood-type/edit'], {
