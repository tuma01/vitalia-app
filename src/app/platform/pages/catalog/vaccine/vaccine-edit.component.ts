...
import { VACCINE_CRUD_CONFIG } from './vaccine-crud.config';
...
export class VaccineEditComponent extends CrudBaseAddEditComponent<Vaccine> implements OnInit {
    protected override entityNameKey = 'menu.catalog.vaccines.singular';
    public readonly config = VACCINE_CRUD_CONFIG();
