...
import { MEDICATION_CRUD_CONFIG } from './medication-crud.config';
...
export class MedicationEditComponent extends CrudBaseAddEditComponent<Medication> implements OnInit {
    protected override entityNameKey = 'menu.catalog.medications.singular';
    public readonly config = MEDICATION_CRUD_CONFIG();
