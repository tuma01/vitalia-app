...
@Component({
    selector: 'app-healthcare-provider-edit',
    standalone: true,
...
export class HealthcareProviderEditComponent extends CrudBaseAddEditComponent<HealthcareProvider> implements OnInit {
