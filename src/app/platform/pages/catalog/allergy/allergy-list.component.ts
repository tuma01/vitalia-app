...
export class AllergyListComponent {
        ...
        this.config.columns.push(
            (getOperationColumn(
                this.translate,
                {
                    ...
                    entityType: 'clinical.allergy.singular',
    ...
    createNew(): void {
        this.router.navigate(['/platform/catalog/allergy/add']);
    }

    edit(record: Allergy): void {
        this.router.navigate(['/platform/catalog/allergy/edit'], {
