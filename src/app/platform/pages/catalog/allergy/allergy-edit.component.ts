...
import { ALLERGY_CRUD_CONFIG } from './allergy-crud.config';
...
export class AllergyEditComponent extends CrudBaseAddEditComponent<Allergy> implements OnInit {
    protected override entityNameKey = 'clinical.allergy.singular';
    public readonly config = ALLERGY_CRUD_CONFIG();
    ...
    protected override getSuccessRoute(): any[] {
        return ['/platform/catalog/allergy/list'];
    }
