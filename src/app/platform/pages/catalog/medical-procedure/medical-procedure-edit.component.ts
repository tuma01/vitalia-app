...
import { MEDICAL_PROCEDURE_CRUD_CONFIG } from './medical-procedure-crud.config';
import { MedicalProcedure } from 'app/api/models/medical-procedure';

@Component({
    selector: 'app-medical-procedure-edit',
    standalone: true,
...
export class MedicalProcedureEditComponent extends CrudBaseAddEditComponent<MedicalProcedure> implements OnInit {
    protected override entityNameKey = 'menu.catalog.procedures.singular';
    public readonly config = MEDICAL_PROCEDURE_CRUD_CONFIG();
