...
export class KinshipListComponent {
    ...
    createNew(): void {
        this.router.navigate(['/platform/catalog/kinship/add']);
    }

    edit(record: Kinship): void {
        this.router.navigate(['/platform/catalog/kinship/edit'], {
