...
CREATE TABLE IF NOT EXISTS CAT_HEALTHCARE_PROVIDER (
    ...
    CONSTRAINT UK_PROVIDER_CODE_TENANT UNIQUE (CODE, TENANT_ID),
    CONSTRAINT UK_PROVIDER_TAX_ID_TENANT UNIQUE (TAX_ID, TENANT_ID),
    CONSTRAINT FK_PROVIDER_HQ_ADDRESS FOREIGN KEY (FK_ID_HQ_ADDRESS) REFERENCES GEO_ADDRESS(ID),
    INDEX IDX_PROVIDER_TENANT (TENANT_ID),
