...
public interface MedicalSpecialtyApi extends GenericApi<MedicalSpecialtyDto> {
        ...
        ResponseEntity<MedicalSpecialtyDto> getSpecialtyById(
                        @Parameter(description = "ID de la " + NAME_API
        ...
        ResponseEntity<MedicalSpecialtyDto> createSpecialty(
                        @Parameter(description = "Detalles de la " + NAME_API
                                        + " a crear.", required = true) @Valid @RequestBody MedicalSpecialtyDto dto);
        ...
        ResponseEntity<MedicalSpecialtyDto> updateSpecialty(
                        ...
                        @Parameter(description = "Nuevos detalles de la " + NAME_API
                                        + ".", required = true) @Valid @RequestBody MedicalSpecialtyDto dto);
