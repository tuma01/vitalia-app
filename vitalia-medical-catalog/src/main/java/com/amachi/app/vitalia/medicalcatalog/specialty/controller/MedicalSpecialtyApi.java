...
@Tag(name = "Medical Specialty", description = "REST API para gestionar el catálogo maestro de especialidades médicas (MDM).")
public interface MedicalSpecialtyApi extends GenericApi<MedicalSpecialtyDto> {
    String NAME_API = "Medical Specialty";
    ...
    ResponseEntity<MedicalSpecialtyDto> getSpecialtyById(
            @Parameter(description = "ID de la " + NAME_API + " a recuperar", required = true)
    ...
    ResponseEntity<MedicalSpecialtyDto> createSpecialty(
            @Parameter(description = "Detalles de la " + NAME_API + " a crear.", required = true)
            @Valid @RequestBody MedicalSpecialtyDto dto
    );
    ...
    ResponseEntity<MedicalSpecialtyDto> updateSpecialty(
            @Parameter(description = "ID de la " + NAME_API + " a actualizar.", required = true)
            @PathVariable("id") Long id,
            @Parameter(description = "Nuevos detalles de la " + NAME_API + ".", required = true)
            @Valid @RequestBody MedicalSpecialtyDto dto
    );
    ...
    ResponseEntity<List<MedicalSpecialtyDto>> getAllSpecialties();
    ...
    ResponseEntity<PageResponseDto<MedicalSpecialtyDto>> getPaginatedSpecialties(
            MedicalSpecialtySearchDto searchDto,
