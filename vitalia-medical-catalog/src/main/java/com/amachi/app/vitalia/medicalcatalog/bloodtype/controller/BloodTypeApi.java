...
@Tag(name = "Blood Type", description = "REST API para gestionar el catálogo maestro de tipos de sangre (MDM).")
public interface BloodTypeApi extends GenericApi<BloodTypeDto> {
    String NAME_API = "Blood Type";
    ...
    ResponseEntity<BloodTypeDto> getBloodTypeById(
    ...
    ResponseEntity<BloodTypeDto> createBloodType(
            @Parameter(description = "Detalles del " + NAME_API
                    + " a crear.", required = true) @Valid @RequestBody @NonNull BloodTypeDto dto);
    ...
    ResponseEntity<Void> deleteBloodType(
            @Parameter(description = "ID del " + NAME_API
    ...
    ResponseEntity<PageResponseDto<BloodTypeDto>> getPaginatedBloodTypes(
            @NonNull BloodTypeSearchDto searchDto,
