...
@Tag(name = "Medication", description = "REST API para gestionar el catálogo de medicamentos (Vademécum - MDM).")
public interface MedicationApi extends GenericApi<MedicationDto> {
    String NAME_API = "Medication";
