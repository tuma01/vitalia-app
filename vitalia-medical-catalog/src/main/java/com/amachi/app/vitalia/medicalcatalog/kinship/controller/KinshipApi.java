...
@Tag(name = "Kinship", description = "REST API para gestionar el catálogo maestro de parentescos (MDM).")
public interface KinshipApi extends GenericApi<KinshipDto> {
    String NAME_API = "Kinship";
    ...
    ResponseEntity<KinshipDto> getKinshipById(
    ...
    ResponseEntity<KinshipDto> createKinship(
            @Parameter(description = "Detalles del " + NAME_API
                    + " a crear.", required = true) @Valid @RequestBody @NonNull KinshipDto dto);
    ...
    ResponseEntity<Void> deleteKinship(
            @Parameter(description = "ID del " + NAME_API
    ...
    ResponseEntity<List<KinshipDto>> getAllKinships();
    ...
    ResponseEntity<PageResponseDto<KinshipDto>> getPaginatedKinships(
            @NonNull KinshipSearchDto searchDto,
