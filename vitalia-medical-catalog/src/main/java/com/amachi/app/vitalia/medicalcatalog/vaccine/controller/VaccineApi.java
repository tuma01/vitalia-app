...
@Tag(name = "Vaccine", description = "REST API para gestionar el catálogo de vacunas (MDM).")
public interface VaccineApi extends GenericApi<VaccineDto> {
    String NAME_API = "Vaccine";
    ...
    ResponseEntity<VaccineDto> getVaccineById(
    ...
    ResponseEntity<VaccineDto> createVaccine(
            @Parameter(description = "Detalles de la " + NAME_API
                    + " a crear.", required = true) @Valid @RequestBody @NonNull VaccineDto dto);
    ...
    ResponseEntity<PageResponseDto<VaccineDto>> getPaginatedVaccines(
            @NonNull VaccineSearchDto searchDto,
