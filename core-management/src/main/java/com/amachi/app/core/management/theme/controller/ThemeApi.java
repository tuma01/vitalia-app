...
@Tag(name = "Theme", description = "REST API para gestionar detalles de temas visuales: crear, actualizar, obtener y eliminar.")
public interface ThemeApi extends GenericApi<ThemeDto> {
        String NAME_API = "Theme";
        ...
        ResponseEntity<ThemeDto> getThemeById(
        ...
        ResponseEntity<ThemeDto> createTheme(
                        @Parameter(description = "Detalles del " + NAME_API
                                        + " a crear.", required = true) @Valid @RequestBody ThemeDto dto);
        ...
        ResponseEntity<PageResponseDto<ThemeDto>> getPaginatedThemes(
                        ThemeSearchDto searchDto,
