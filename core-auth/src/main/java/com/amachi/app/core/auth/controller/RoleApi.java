...
@Tag(name = "Role", description = "REST API para gestionar detalles de roles: crear, actualizar, obtener y eliminar.")
public interface RoleApi extends GenericApi<RoleDto> {
    String NAME_API = "Role";
