package com.amachi.app.vitalia.tenantconfig.controller;

import com.amachi.app.vitalia.common.controller.GenericApi;
import com.amachi.app.vitalia.common.dto.PageResponseDto;
import com.amachi.app.vitalia.tenantconfig.dto.TenantConfigDto;
...
@Tag(name = "TenantConfig", description = "REST API para gestionar detalles de tenantConfigs: crear, actualizar, obtener y eliminar.")
public interface TenantConfigApi extends GenericApi<TenantConfigDto> {
    ...
    ResponseEntity<TenantConfigDto> createTenantConfig(
    ...
    ResponseEntity<List<TenantConfigDto>> getAllTenantConfigs();
    ...
    ResponseEntity<PageResponseDto<TenantConfigDto>> getPaginatedTenantConfigs(TenantConfigSearchDto searchDto,
