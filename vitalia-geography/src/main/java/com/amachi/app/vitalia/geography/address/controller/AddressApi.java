package com.amachi.app.vitalia.geography.address.controller;
...
@Tag(name = "Address", description = "REST API para gestionar detalles de addresses: crear, actualizar, obtener y eliminar.")
